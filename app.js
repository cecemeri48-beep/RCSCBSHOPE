...
async function openPrintCard(member, mode='pdf') {
  ...
  const qr = (member.public_token || member.id) ? verifyUrl(member.public_token || member.id) : '';
