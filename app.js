...
function openCardPreview(member) {
  ...
  const modal=$('#cardModal'); const body=$('#cardModalBody'); const logo=$('.brand img')?.src || ''; const compass='assets/reichas-virtual-stamp.png'; const house='legacy-house-forest-gray.jpg';
...
async function openPrintCard(member, mode='pdf') {
  ...
  const logo = $('.brand img')?.src || '';
  const compass = 'assets/reichas-virtual-stamp.png';
