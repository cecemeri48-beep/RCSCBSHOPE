...
function openCardPreview(member) {
  ...
  const modal=$('#cardModal'); const body=$('#cardModalBody'); const logo=$('.brand img')?.src || ''; const compass='legacy-compass-gold-3d.jpg'; const house='legacy-house-gray.png';
...
async function openPrintCard(member, mode='pdf') {
  ...
  const logo = $('.brand img')?.src || '';
  const compass = 'legacy-compass-gold-3d.jpg';
