...
function displayCardSequence(value='') { const raw=String(value || '').trim(); if (!raw) return '-'; const parts=raw.split(/[·|]/).map(part=>part.trim()).filter(Boolean); const roman=parts.find(part=>/^[IVXLCDM]+$/i.test(part)); if (roman) return roman.toUpperCase(); const numeric=raw.match(/(?:^|[^\d])(\d{1,4})(?:[^\d]|$)/); return numeric ? numeric[1] : '-'; }
...
async function openPrintCard(member, mode='pdf') {
  ...
  const logo = $('.brand img')?.src || '';
  const compass = 'legacy-compass-gold-3d.png';
  ...
  const backSvg=`<svg xmlns="http://www.w3.org/2000/svg" width="860" height="540" viewBox="0 0 860 540"><defs><linearGradient id="back" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#f7f8f6"/><stop offset="1" stop-color="#ead9cc"/></linearGradient></defs><rect width="860" height="540" rx="38" fill="url(#back)" stroke="#ead8cb" stroke-width="3"/><text x="68" y="76" fill="#7a8782" font-family="Arial" font-weight="700" font-size="16" letter-spacing="4">REICHAS CHELEBES</text><image href="${houseHref}" x="430" y="0" width="430" height="540" preserveAspectRatio="xMidYMid slice" opacity=".34"/><image href="${compassHref}" x="548" y="78" width="220" height="220" preserveAspectRatio="xMidYMid meet" opacity=".28"/><text x="68" y="130" fill="#b83c35" font-family="Arial" font-weight="700" font-size="32">Bangga menjadi bagian</text><text x="68" y="172" fill="#b83c35" font-family="Arial" font-weight="700" font-size="32">Keluarga RCS.CBS.</text><text x="68" y="235" fill="#667478" font-family="Arial" font-size="18">Di mana pun langkah membawa kita,</text><text x="68" y="268" fill="#667478" font-family="Arial" font-size="18">Keluarga Reichas Chelebes tetap terhubung.</text><text x="68" y="310" fill="#667478" font-family="Arial" font-size="17">Kartu ini adalah identitas anggota—jembatan</text><text x="68" y="340" fill="#667478" font-family="Arial" font-size="17">komunikasi, koordinasi, dan kepedulian.</text><text x="68" y="370" fill="#899695" font-family="Arial" font-size="12" font-weight="700" letter-spacing="2">PEMILIK LEGACY</text><text x="68" y="398" fill="#5f6e6e" font-family="Arial" font-size="18" font-weight="700">${parent}</text><text x="68" y="434" fill="#899695" font-family="Arial" font-size="12" font-weight="700" letter-spacing="2">NAMA ANGKATAN</text><text x="68" y="462" fill="#5f6e6e" font-family="Arial" font-size="18" font-weight="700">${cohort}</text><text x="68" y="498" fill="#899695" font-family="Arial" font-size="12" font-weight="700" letter-spacing="2">NO. URUT KARTU</text><text x="68" y="526" fill="#5f6e6e" font-family="Arial" font-size="18" font-weight="700">${cardSequence}</text><text x="650" y="472" fill="#b83c35" fill-opacity=".24" font-family="Arial" font-weight="700" font-size="22" letter-spacing="4" text-anchor="middle">RCS.CBS HOPE</text></svg>`;
  if (mode==='png') {
