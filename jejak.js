(() => {
  ...
  const shareData = {
    ...
    url: new URL('jejak.html?v=18', document.baseURI).href
  };
  ...
  if ('serviceWorker' in navigator) window.addEventListener('load', () => navigator.serviceWorker.register('jejak-sw.js?v=18').catch(() => {}));
})();
