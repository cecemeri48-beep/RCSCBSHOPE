(() => {
  ...
  const shareData = {
    ...
    url: new URL('jejak.html?v=28', document.baseURI).href
  };
  ...
  if ('serviceWorker' in navigator) window.addEventListener('load', () => navigator.serviceWorker.register('jejak-sw.js?v=28').catch(() => {}));
})();
