...
- `album.html` + `album.css` — album foto kenangan dengan tampilan grid Google Drive.
...
- `jejak-universe.jpg` — background hyper-realistic alam dan semesta (diletakkan satu folder dengan `jejak.html`)
